...
//  Программа 2. Задает одномерный массив, заполненный случайными числами. 
...
//  Программа 3.  Задает массив случайных вещественных чисел. 
//  Находит разницу между максимальным и минимальным элементом массива.
OutInfo("__________________________________________________________");
OutInfo("№3 Задает одномерный массив, заполненный случайными числами.");
OutInfo("Находит разницу между максимальным и минимальным элементом массива.");
OutInfo("");
